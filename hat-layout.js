(()=>{
 ...
 function place(){
  ...
  // Target 130% of the previous layout, then cap it to the safe space.
  ...
  const width=Math.min(previousWidth*1.3,available*1.5,innerWidth*.94),center=(signBottom+dashTop)/2;
